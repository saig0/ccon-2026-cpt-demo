-- =============================================================================
-- Camunda Robotics – Troubleshooting Knowledge Base: Example Data
-- =============================================================================

INSERT INTO knowledge_base_entries (id, problem, keywords, solution)
VALUES (1,
...
-- Upgrades
-- ---------------------------------------------------------------------------
INSERT INTO upgrades (id, name, description, price)
VALUES (1, 'Multi-Language Translator Module v2',
...
-- Robots
-- ---------------------------------------------------------------------------
INSERT INTO robots (id, model_id, model_version, name, description, intent, price)
VALUES
...
-- C-3PO v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (1, 1), -- Multi-Language Translator Module v2
       (1, 2), -- Pet Language Translator Module
       (1, 3);
-- Reduced Verbosity Module

-- C-3PX v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (2, 1), -- Multi-Language Translator Module v2
       (2, 2), -- Pet Language Translator Module
       (2, 3), -- Reduced Verbosity Module
       (2, 12);
-- Faster Processor Chip v2

-- R2-D2 (ASTROMECH R2)
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (3, 4), -- Extended Map Database v3
       (3, 5), -- Precision Navigation Array
       (3, 20);
-- Astromech Toolkit v2

-- R3-T7 (ASTROMECH R3)
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (4, 4),  -- Extended Map Database v3
...
-- R4-P17 (ASTROMECH R4)
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (5, 4), -- Extended Map Database v3
...
-- R5-D4 (ASTROMECH R5)
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (6, 4), -- Extended Map Database v3
       (6, 20);
-- Astromech Toolkit v2

-- BB-8 (ASTROMECH BB)
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (7, 4), -- Extended Map Database v3
...
-- Bender v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (8, 6), -- Exhaust Gas Filter Pro
       (8, 7);
-- Titanium Arm Upgrade

-- Baymax v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (9, 8), -- Pet Care Suite
       (9, 9), -- Mental Health Care Package
       (9, 23);
-- Medical Diagnostics Plus

-- Baymax v2.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (10, 8),  -- Pet Care Suite
...
-- Data v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (11, 12), -- Faster Processor Chip v2
       (11, 24);
-- Quantum Computation Upgrade

-- T-800 v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (12, 13), -- Reinforced Combat Armor
       (12, 14);
-- Advanced Weapons Array

-- T-800 v2.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (13, 13), -- Reinforced Combat Armor
...
-- T-1000 (T-800 T-1000)
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (14, 17), -- Stealth Infiltration Module
...
-- WALL-E v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (15, 15), -- Solar Energy Harvester
       (15, 16);
-- Enhanced Waste Compactor

-- EVE v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (16, 5), -- Precision Navigation Array
       (16, 19);
-- Tactical Analysis Matrix

-- Optimus Prime v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (17, 21), -- Energon Power Cell
...
-- K-2SO v1.0
INSERT INTO robot_compatible_upgrades (robot_id, upgrade_id)
VALUES (18, 19), -- Tactical Analysis Matrix
...
INSERT INTO order_items (order_id, robot_id, quantity)
VALUES (1, 15, 1);

-- Order 2: Zee buys Enhanced Waste Compactor upgrade (upgrades.id = 16)
INSERT INTO order_items (order_id, upgrade_id, quantity)
VALUES (2, 16, 1);
...
-- =============================================================================
-- Align identity generators with explicit seed IDs
-- =============================================================================
